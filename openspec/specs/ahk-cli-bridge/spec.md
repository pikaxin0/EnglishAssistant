# AHK CLI Bridge Capability

## Purpose

Enables AutoHotkey scripts to invoke the Node.js CLI translation service, providing bidirectional communication through temp files. This bridge allows Windows UI Automation integration with the existing translation infrastructure without modifying the CLI interface.
